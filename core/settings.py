...
SECRET_KEY = 'django-insecure-7vd=$0v!%xl@dhmdbtcvialwf1j)#!svxn$241gfa(x2^%oks5'
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PAGINATION_CLASS': 'landing_page.pagination.CustomPagination',
